...
/* Η δομή block_info κρατάει μεταδεδομένα που σχετίζονται με το block   */
/* Θα το αποθηκεύουμαι στο τέλος κάθε block. Δεν είναι αναγκαίο για το  */
/* πρόγραμμα μας αλλά η εκφώνηση το ζήταγε να το έχουμε για κάποιον λόγο*/
typedef struct {
    int numOfRecords;
} block_info;
...
*/
HP_info* HP_OpenFile( char *fileName /* όνομα αρχείου */, int *fileDesc);
